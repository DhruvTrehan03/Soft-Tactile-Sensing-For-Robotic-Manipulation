...
% Process the data
EIT = smoothdata(Left_Data(29:172,2:end), 'gaussian', 7);
...
closest_values = [40, 57, 72, 89, 109, 125, 139, 157]-29; % Adjusted for the EIT data range
...
for i = 1:length(closest_values)
    plot(EIT(closest_values(i), :), 'DisplayName', sprintf("Slice %d", i));
end
