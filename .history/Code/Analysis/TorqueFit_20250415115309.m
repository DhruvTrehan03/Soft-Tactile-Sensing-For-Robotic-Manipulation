...
if params
    data_dir = "SavedVariables\TorqueFitting_10mm";
    train_torque = load("SavedVariables\TorqueFitting\Torque_10mm.mat").trainTorquePeaks';
    test_torque = load("SavedVariables\TorqueFitting\Torque_10mm.mat").testTorquePeaks';
...
Corr_vs_K_AllDiameters(base_dir, diameters, mdl, stim, sigma_fixed, k_values, smooth_coeff)
...
if fit
    ...
    test_results = load("SavedVariables\TrainedParameter.mat").test_results;
    [k_fit,sigma_fit]=fit_torque(train_results);
    evaluate_fit(test_results, k_fit, sigma_fit);
    analyze_torque_fit(train_results, test_results)
