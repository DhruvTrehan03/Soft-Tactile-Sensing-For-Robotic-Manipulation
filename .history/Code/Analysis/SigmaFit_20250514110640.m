...
function [corr_score, env1, env2] = envelope_correlation(data1, data2, smooth_coeff)
    ...
    if isempty(env_fig) || ~isvalid(env_fig)
        ...
        hold(env_ax1, 'on');
        env_ax2 = plot(env_ax1, NaN, 'r', 'DisplayName', 'Normalized Data1');
        plot(env_ax1, NaN, 'b', 'DisplayName', 'Normalized Data2');
        plot(env_ax1, NaN, 'r--', 'DisplayName', 'Envelope1');
        plot(env_ax1, NaN, 'b--', 'DisplayName', 'Envelope2');
        legend(env_ax1, 'show');
    end
    figure(env_fig);
