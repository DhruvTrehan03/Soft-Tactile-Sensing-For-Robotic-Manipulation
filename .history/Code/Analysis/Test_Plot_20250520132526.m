...
% Plot for sigma^2 vs torque with polynomial fits
figure;
plot(sigma_squared_sorted, torque_sorted, 'o', 'DisplayName', 'Data');
hold on;
plot(sigma_squared_sorted, fitted_torque_p1_sigma_squared, '-r', 'DisplayName', 'Order 1 Fit');
plot(sigma_squared_sorted, fitted_torque_p2_sigma_squared, '--g', 'DisplayName', 'Order 2 Fit');
xlabel('Sigma^2');
ylabel('Torque');
title('Sigma^2 vs Torque with Polynomial Fits');
legend('show');
grid on;
