...
scatter(maxima_k, maxima_sigma, 75, torque_values, 'filled');
xlabel('k');
ylabel('Sigma');
...
%increment cluster_idx by 1 modulo 10 to avoid zero index
cluster_idx = mod(cluster_idx, num_clusters)+1;
...
plot(torque_values, 'FaceColor', [0.2 0.6 0.8], 'EdgeColor', 'k', 'LineWidth', 1.5);
% Plot the clusters
figure;
