...
for i = 1:length(select_fcns)
    ...
    TFit(base_dir, mdl, stim, plain, plain_data, select_fcns{i}, sigma_values, smooth_coeff);
end

function TFit(base_dir, mdl, stim, plain, plain_data, select_fcn, sigma_values, smooth_coeff)
    ...
    for i = 1:length(files)
        ...
        data = load(file_path);
        data_diff = smoothdata(data.data_diff', "gaussian", 9); % Smooth data_diff
