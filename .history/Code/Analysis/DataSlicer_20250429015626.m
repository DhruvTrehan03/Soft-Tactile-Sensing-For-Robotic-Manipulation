...
right_file = fullfile(folder, sprintf("%d mm_1_right.mat",d));
truth_file = fullfile(folder, sprintf("%d mm_1_truth.mat",d));
...
EIT_O = EIT;
EIT = smoothdata(EIT(27:180,2:end), 'gaussian', 5);
...
closest_values = [11, 60, 85, 104, 118, 131, 141]; % Adjusted for the EIT data range
