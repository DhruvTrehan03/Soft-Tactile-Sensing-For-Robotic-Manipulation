        ...
        for i = 1:length(files)
            ...
            for k_idx = 1:length(k_values)
                for sigma_idx = 1:length(sigma_values)
                    ...
                    [cross_corr, ~] = xcorr(calculate_envelope(data_diff,50), calculate_envelope(sim_data,50), 'coeff');
            ...
            maxima_matrix = [maxima_matrix; diameter_value, k_values(max_k_idx), sigma_values(max_sigma_idx)];
        end
        close(progress);
