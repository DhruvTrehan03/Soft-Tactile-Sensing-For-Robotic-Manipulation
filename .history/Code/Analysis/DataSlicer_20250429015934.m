...
EIT_O = EIT;
EIT = smoothdata(EIT(:,2:end), 'gaussian', 7);

EIT_Time = Left_Data(:,1);
[pks, locs] = findpeaks(Load_Data(:,2), 'MinPeakHeight', 0.0);
disp(pks);
...
closest_values = [11, 60, 85, 118, 131, 141]; % Adjusted for the EIT data range
