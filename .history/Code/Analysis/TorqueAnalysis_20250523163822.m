...
function TFit(base_dir)
    ...
    for i = 1:length(files)
        ...
        % Save pdf of the heatmap
        exportgraphics(gcf, fullfile("Heatmaps\", sprintf('Heatmap_Torque_%.2f.pdf', torque_values(i))), 'ContentType', 'vector');
        close(gcf);
    end
    ...
    disp('Maxima data saved to maxima_data.mat');
