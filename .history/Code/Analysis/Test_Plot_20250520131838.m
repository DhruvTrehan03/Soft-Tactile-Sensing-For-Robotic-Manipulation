...
xlabel('Sigma');
ylabel('Torque');
title(sprintf('Clustered Maxima of k vs Sigma with Torque as Color Gradient, MSE = %.2f', mean((y - torque_means).^2)));
legend('Torque', sprintf('Line of Best Fit equation: y = %.2fx^2 + %.2fx + %.2f', p(1), p(2), p(3)));
colorbar;
grid on;
