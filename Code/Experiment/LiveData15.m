...
save_dir = fullfile('C:\Users\dhruv\Soft-Tactile-Sensing-For-Robotic-Manipulation\Readings\40mm\Load', time_str);
mkdir(save_dir)
...
% Save data
save(fullfile(save_dir, 'truth.mat'), 'plotthis');
clear device;
disp('Truth device readings saved.');
