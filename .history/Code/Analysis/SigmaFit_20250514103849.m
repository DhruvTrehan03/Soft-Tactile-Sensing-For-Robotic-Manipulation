    ...
    for i = 1:length(select_fcns)
        ...
        SigmaFit(base_dir, diameters, mdl, stim,plain, select_fcns{i}, sigma_values, smooth_coeff, 'sigma_corr_matrix.mat');
    end



function SigmaFit(base_dir, diameters, mdl, stim, select_fcn, sigma_values, smooth_coeff, save_path)
